...
def app():
    ...
    st.image(os.path.join(folder_dir, 'data/pitBars.png'),
            caption="image source: https://endhomelessness.org/homelessness-in-america/homelessness-statistics/state-of-homelessness-2021/", use_column_width=True)
    ...
    st.image(os.path.join(folder_dir, 'data/covid.jpg'), caption="image source: https://www.texasattorneygeneral.gov/", use_column_width=True)
    ...
    st.image(os.path.join(folder_dir, 'data/outreach.jpg'), caption="image source: https://goldentriangledc.com/what-we-do/homeless-outreach/", use_column_width=True)
    ...
    st.image(os.path.join(folder_dir, 'data/housing.jpg'), caption="image source: https://www.archdaily.com/963912/we-already-have-viable-models-for-quality-affordable-housing", use_column_width=True)
