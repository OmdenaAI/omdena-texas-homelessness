...
#import our data
strat_df1 = pd.read_csv("C:/Users/SALAKO/dlib/omdena-texas-homelessness/src/tasks/task-2-EDA/cleaned_datasets/strat_measure_of_persons_experiencing_homelessness_pit_counts.csv")
